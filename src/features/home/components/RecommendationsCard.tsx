...
import { VerseRecommendation } from '@/features/home/lib/recommendations';
      ...
      <div className="space-y-3">
        {recommendations.map((rec) => (
          <button
            ...
            className="w-full text-left bg-bg-surface border border-border rounded-2xl p-4 border-l-[3px] border-l-gold hover:bg-bg-hover transition-colors cursor-pointer"
          >
